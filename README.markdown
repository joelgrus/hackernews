...
You can do what you want with the results.  I post mine to Blogger, using the code in "blogger.rb".  This runs automatically once an hour, as does "scrape_api.rb".
